defmodule BloodPressureBoardWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BloodPressureBoardWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BloodPressureBoardWeb.Gettext, "errors", msg, opts)
    end
  end
